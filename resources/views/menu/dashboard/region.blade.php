...
<table id="tableboard" class="col-12">
                <thead id="theadboard">
                    <tr id="trboard">
                        <th id="thboard" rowspan="4">Tanggal</th>
                            @if(isset($_GET['select']) == 'region' )
                            <th id="thboard1" rowspan="4">REGION</th>
                            @elseif(isset($_GET['select']) == 'area' )
                            <th id="thboard1" rowspan="4">AREA</th>
                            @elseif(isset($_GET['select']) == 'sales_area' )
                            <th id="thboard1" rowspan="4">SALES AREA</th>
                            @elseif(isset($_GET['select']) == 'cluster' )
                            <th id="thboard1" rowspan="4">CLUSTER</th>
                            @elseif(isset($_GET['select']) == 'micro_cluster' )
                ...
                <tbody id="sell_in">
                    ...
                    <tr id="trboard">
                        ...
                        <td id="tdboard1">{{$item['destination']}}</td>
